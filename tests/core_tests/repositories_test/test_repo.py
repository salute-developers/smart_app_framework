...
class MockStream:
    def __init__(self, data):
        ...
        self.stream.read.return_value = orjson.dumps(self.data)
...
class FolderRepositoryTest(unittest.TestCase):
    ...
    def test_right_filling_with_dict(self):
        test_repository = FolderRepository('', loader=orjson.loads,
...
class TestClassifierRepository(unittest.TestCase):
            ...
            with patch("core.repositories.folder_repository.FolderRepository.load"):
                with patch("core.repositories.classifier_repository.classifiers_initial_launch"):
                    classifier_repo = ClassifierRepository(
                        self.temp_directory_path, self.temp_directory_path, orjson.loads, "")
    ...
    def test_load_if_not_classifiers_paths(self):
        classifier_repo = ClassifierRepository("./nonexistent_path", "./another_nonexistent_path", orjson.loads, "")
        classifier_repo.load()
    ...
    def test_load_if_classifiers_directories_are_empty(self):
        ...
        classifier_repo = ClassifierRepository(empty_temp_directory_name, empty_temp_directory_name, orjson.loads, "")
        classifier_repo.load()
